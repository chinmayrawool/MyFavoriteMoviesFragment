...
public class YearFragment extends Fragment {
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        ImageButton btn_first=(ImageButton)getView().findViewById(R.id.imageButtonFirst);
        ImageButton btn_previous=(ImageButton)getView().findViewById(R.id.imageButtonPrevious);
        ImageButton btn_next=(ImageButton)getView().findViewById(R.id.imageButtonNext);
        ImageButton btn_last=(ImageButton)getView().findViewById(R.id.imageButtonLast);
        Button btn_finish = (Button) getView().findViewById(R.id.buttonFinishYear);
